...
const Pipeline *           loadNKlassCompactHeadersNode::pipeline_class() { return (&pipeline_class_043); }
const Pipeline *           loadNKlassCompactHeadersNode::pipeline() const { return (&pipeline_class_043); }
...
const Pipeline *               CallLeafDirectVectorNode::pipeline_class() { return (&pipeline_class_057); }
const Pipeline *               CallLeafDirectVectorNode::pipeline() const { return (&pipeline_class_057); }
...
const Pipeline *                ForwardExceptionjmpNode::pipeline_class() { return (&pipeline_class_057); }
const Pipeline *                ForwardExceptionjmpNode::pipeline() const { return (&pipeline_class_057); }
...
const Pipeline *        partialSubtypeCheckVarSuperNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *        partialSubtypeCheckVarSuperNode::pipeline() const { return (&pipeline_class_056); }

const Pipeline *      partialSubtypeCheckConstSuperNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *      partialSubtypeCheckConstSuperNode::pipeline() const { return (&pipeline_class_056); }
...
const Pipeline *                    arrays_hashcodeNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *                    arrays_hashcodeNode::pipeline() const { return (&pipeline_class_056); }
...
const Pipeline * reduce_non_strict_order_add2F_neonNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline * reduce_non_strict_order_add2F_neonNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline * reduce_non_strict_order_add4F_neonNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline * reduce_non_strict_order_add4F_neonNode::pipeline() const { return (&pipeline_class_052); }
...
const Pipeline * reduce_non_strict_order_add2D_neonNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline * reduce_non_strict_order_add2D_neonNode::pipeline() const { return (&pipeline_class_052); }
...
const Pipeline *                           g1StorePNode::pipeline_class() { return (&pipeline_class_046); }
const Pipeline *                           g1StorePNode::pipeline() const { return (&pipeline_class_046); }

const Pipeline *                   g1StorePVolatileNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *                   g1StorePVolatileNode::pipeline() const { return (&pipeline_class_056); }

const Pipeline *                           g1StoreNNode::pipeline_class() { return (&pipeline_class_046); }
const Pipeline *                           g1StoreNNode::pipeline() const { return (&pipeline_class_046); }

const Pipeline *                   g1StoreNVolatileNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *                   g1StoreNVolatileNode::pipeline() const { return (&pipeline_class_056); }

const Pipeline *                 g1EncodePAndStoreNNode::pipeline_class() { return (&pipeline_class_046); }
const Pipeline *                 g1EncodePAndStoreNNode::pipeline() const { return (&pipeline_class_046); }

const Pipeline *         g1EncodePAndStoreNVolatileNode::pipeline_class() { return (&pipeline_class_056); }
const Pipeline *         g1EncodePAndStoreNVolatileNode::pipeline() const { return (&pipeline_class_056); }

const Pipeline *              g1CompareAndExchangePNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *              g1CompareAndExchangePNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *           g1CompareAndExchangePAcqNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *           g1CompareAndExchangePAcqNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *              g1CompareAndExchangeNNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *              g1CompareAndExchangeNNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *           g1CompareAndExchangeNAcqNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *           g1CompareAndExchangeNAcqNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *                  g1CompareAndSwapPNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *                  g1CompareAndSwapPNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *                g1CompareAndSwapP_0Node::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *                g1CompareAndSwapP_0Node::pipeline() const { return (&pipeline_class_052); }

const Pipeline *               g1CompareAndSwapPAcqNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *               g1CompareAndSwapPAcqNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *             g1CompareAndSwapPAcq_0Node::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *             g1CompareAndSwapPAcq_0Node::pipeline() const { return (&pipeline_class_052); }

const Pipeline *                  g1CompareAndSwapNNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *                  g1CompareAndSwapNNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *                g1CompareAndSwapN_0Node::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *                g1CompareAndSwapN_0Node::pipeline() const { return (&pipeline_class_052); }

const Pipeline *               g1CompareAndSwapNAcqNode::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *               g1CompareAndSwapNAcqNode::pipeline() const { return (&pipeline_class_052); }

const Pipeline *             g1CompareAndSwapNAcq_0Node::pipeline_class() { return (&pipeline_class_052); }
const Pipeline *             g1CompareAndSwapNAcq_0Node::pipeline() const { return (&pipeline_class_052); }

const Pipeline *                       g1GetAndSetPNode::pipeline_class() { return (&pipeline_class_051); }
const Pipeline *                       g1GetAndSetPNode::pipeline() const { return (&pipeline_class_051); }

const Pipeline *                    g1GetAndSetPAcqNode::pipeline_class() { return (&pipeline_class_051); }
const Pipeline *                    g1GetAndSetPAcqNode::pipeline() const { return (&pipeline_class_051); }

const Pipeline *                       g1GetAndSetNNode::pipeline_class() { return (&pipeline_class_051); }
const Pipeline *                       g1GetAndSetNNode::pipeline() const { return (&pipeline_class_051); }

const Pipeline *                    g1GetAndSetNAcqNode::pipeline_class() { return (&pipeline_class_051); }
const Pipeline *                    g1GetAndSetNAcqNode::pipeline() const { return (&pipeline_class_051); }

const Pipeline *                            g1LoadPNode::pipeline_class() { return (&pipeline_class_043); }
const Pipeline *                            g1LoadPNode::pipeline() const { return (&pipeline_class_043); }

const Pipeline *                            g1LoadNNode::pipeline_class() { return (&pipeline_class_043); }
const Pipeline *                            g1LoadNNode::pipeline() const { return (&pipeline_class_043); }
