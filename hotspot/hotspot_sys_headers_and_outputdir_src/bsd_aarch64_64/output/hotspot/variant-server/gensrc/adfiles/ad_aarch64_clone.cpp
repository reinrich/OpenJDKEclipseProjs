...
MachOper *immI_positiveOper::clone() const {
  return new immI_positiveOper(_c0);
}
MachOper *immI_cmp_condOper::clone() const {
  return new immI_cmp_condOper(_c0);
}
MachOper *immI_cmpU_condOper::clone() const {
  return new immI_cmpU_condOper(_c0);
}
...
MachOper *immI5Oper::clone() const {
  return new immI5Oper(_c0);
}
MachOper *immIU7Oper::clone() const {
  return new immIU7Oper(_c0);
}
...
MachOper *immL5Oper::clone() const {
  return new immL5Oper(_c0);
}
MachOper *immLU7Oper::clone() const {
  return new immLU7Oper(_c0);
}
