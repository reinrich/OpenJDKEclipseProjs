...
const RegMask &loadBarrierSlowRegNoVecNode::out_RegMask() const { return (PTR_REG_mask()); }
const RegMask &loadBarrierSlowRegXmmAndYmmNode::out_RegMask() const { return (PTR_REG_mask()); }
const RegMask &loadBarrierSlowRegZmmNode::out_RegMask() const { return (PTR_REG_mask()); }
const RegMask &loadBarrierWeakSlowRegNoVecNode::out_RegMask() const { return (PTR_REG_mask()); }
const RegMask &loadBarrierWeakSlowRegXmmAndYmmNode::out_RegMask() const { return (PTR_REG_mask()); }
const RegMask &loadBarrierWeakSlowRegZmmNode::out_RegMask() const { return (PTR_REG_mask()); }
...
const RegMask &vadd4B_mem_avx_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evex_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evex_special_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vadd8B_mem_avx_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evex_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evex_special_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd16B_mem_avx_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evex_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evex_special_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd32B_mem_avx_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evex_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evex_special_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd64B_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2S_mem_avx_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evex_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evex_special_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vadd4S_mem_avx_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evex_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evex_special_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd8S_mem_avx_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evex_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evex_special_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd16S_mem_avx_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evex_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evex_special_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd32S_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2I_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd4I_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd8I_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd16I_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2L_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd4L_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd8L_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2F_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd4F_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd8F_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd16F_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2D_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vadd4D_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd8D_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2S_mem_avx_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evex_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evex_special_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vmul4S_mem_avx_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evex_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evex_special_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul8S_mem_avx_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evex_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evex_special_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vmul16S_mem_avx_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evex_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evex_special_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul32S_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2I_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul4I_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vmul2L_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vmul4L_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul8L_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul8I_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul16I_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2F_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul4F_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vmul8F_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul16F_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2D_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vmul4D_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul8D_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vcmov8F_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsqrt2F_regNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsqrt2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsqrt4F_regNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsqrt4F_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsqrt8F_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsqrt8F_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsqrt16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsqrt16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vand4B_mem_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vand8B_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vand16B_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vand32B_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vand64B_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vor4B_mem_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vor8B_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vor16B_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vor32B_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vor64B_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vxor4B_mem_0Node::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vxor8B_mem_0Node::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vxor16B_mem_0Node::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &vxor32B_mem_0Node::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vxor64B_mem_0Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vfma2D_regNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vfma2D_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vfma4D_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vfma4D_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vfma8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vfma8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vfma4F_regNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vfma4F_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vfma8F_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vfma8F_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vfma16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vfma16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vpopcount8INode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vpopcount16INode::out_RegMask() const { return (VECTORZ_REG_mask()); }
