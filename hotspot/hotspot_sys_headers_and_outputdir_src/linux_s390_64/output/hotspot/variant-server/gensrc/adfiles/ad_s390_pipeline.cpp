...
static const Pipeline pipeline_class_001((uint)stage_undefined, 0, true, 4, 1, false, false, false,
 nullptr,  (enum machPipelineStages *) pipeline_res_stages_001,
  (uint *) pipeline_res_cycles_001,
  Pipeline_Use(0x0, 0x0, 0, (Pipeline_Use_Element *)nullptr));

// Pipeline Class "pipe_class_trap"
static const Pipeline pipeline_class_002((uint)stage_undefined, 0, false, 0, 1, false, false, false,
 nullptr,  (enum machPipelineStages *) pipeline_res_stages_001,
  (uint *) pipeline_res_cycles_001,
  Pipeline_Use(0x0, 0x0, 0, (Pipeline_Use_Element *)nullptr));
...
static const Pipeline pipeline_class_003((uint)stage_Z_EX1, 2, false, 0, 1, false, false, false,

  (enum machPipelineStages *) pipeline_reads_001,
   (enum machPipelineStages *) pipeline_res_stages_002,
  (uint *) pipeline_res_cycles_002,
  Pipeline_Use(0xc, 0x0, 1, (Pipeline_Use_Element *)&pipeline_res_mask_002[0]));
...
static const Pipeline pipeline_class_004((uint)stage_Z_WB, 1, false, 0, 1, false, false, false,

  (enum machPipelineStages *) pipeline_reads_002,
   (enum machPipelineStages *) pipeline_res_stages_003,
  (uint *) pipeline_res_cycles_003,
  Pipeline_Use(0x30, 0x0, 1, (Pipeline_Use_Element *)&pipeline_res_mask_003[0]));
...
const Pipeline *      loadNKlassCompactHeadersNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *      loadNKlassCompactHeadersNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *              membar_storeloadNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *              membar_storeloadNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                   membar_fullNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                   membar_fullNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                        castVVNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                        castVVNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 umodI_reg_regNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 umodI_reg_regNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 umodL_reg_regNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 umodL_reg_regNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                      absL_regNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                      absL_regNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *           ForwardExceptionjmpNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *           ForwardExceptionjmpNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *   partialSubtypeCheckVarSuperNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *   partialSubtypeCheckVarSuperNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline * partialSubtypeCheckConstSuperNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline * partialSubtypeCheckConstSuperNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 indexOfChar_LNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 indexOfChar_LNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 repl8S_reg_ExNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 repl8S_reg_ExNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 repl4I_reg_ExNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 repl4I_reg_ExNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 repl4F_reg_ExNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 repl4F_reg_ExNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                repl16B_reg_ExNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                repl16B_reg_ExNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                 repl2L_reg_ExNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                 repl2L_reg_ExNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                   reinterpretNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                   reinterpretNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                  reinterpretXNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                  reinterpretXNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                   vmul16B_regNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                   vmul16B_regNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                popCountI_Ext3Node::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                popCountI_Ext3Node::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                popCountL_Ext3Node::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                popCountL_Ext3Node::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *                      g1StorePNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                      g1StorePNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                      g1StoreNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                      g1StoreNNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *             g1CompareAndSwapNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *             g1CompareAndSwapNNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *           g1CompareAndSwapN_0Node::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *           g1CompareAndSwapN_0Node::pipeline() const { return (&pipeline_class_001); }

const Pipeline *         g1CompareAndExchangeNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *         g1CompareAndExchangeNNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                       g1LoadNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                       g1LoadNNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                  g1GetAndSetNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                  g1GetAndSetNNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *             g1CompareAndSwapPNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *             g1CompareAndSwapPNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *           g1CompareAndSwapP_0Node::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *           g1CompareAndSwapP_0Node::pipeline() const { return (&pipeline_class_001); }

const Pipeline *         g1CompareAndExchangePNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *         g1CompareAndExchangePNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                       g1LoadPNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                       g1LoadPNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *                  g1GetAndSetPNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *                  g1GetAndSetPNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *            g1EncodePAndStoreNNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *            g1EncodePAndStoreNNode::pipeline() const { return (&pipeline_class_001); }
