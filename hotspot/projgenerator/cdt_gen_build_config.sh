...
EOF
	    ...
	    # echo "_MSC_VER=1400" >> $ALL_DEFINES # this we get with the method above
            ...
            cat << EOF > $SYS_HEADERS_AND_OUTPUTDIR_SRC_ARCHIVE_STEM_DIR_ABS/manual_defs.hpp
// Generated by cdt_gen_build_config.sh. Don not edit.
// The definitions are manual in the sense that the cannot be extracted from MS Visual C++
