...
#undef java_net_SocketInputStream_DEFAULT_BUFFER_SIZE
#define java_net_SocketInputStream_DEFAULT_BUFFER_SIZE 8192L
#undef java_net_SocketInputStream_MAX_BUFFER_SIZE
#define java_net_SocketInputStream_MAX_BUFFER_SIZE 2147483639L
/*
