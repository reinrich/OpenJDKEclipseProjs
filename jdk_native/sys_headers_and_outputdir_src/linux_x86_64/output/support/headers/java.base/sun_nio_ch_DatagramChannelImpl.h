...
#undef sun_nio_ch_DatagramChannelImpl_ST_KILLPENDING
#define sun_nio_ch_DatagramChannelImpl_ST_KILLPENDING 3L
#undef sun_nio_ch_DatagramChannelImpl_ST_KILLED
#define sun_nio_ch_DatagramChannelImpl_ST_KILLED 4L
/*
