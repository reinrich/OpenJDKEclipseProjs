...
extern "C" {
#endif
#undef java_net_Inet4Address_PREFER_IPV4_VALUE
#define java_net_Inet4Address_PREFER_IPV4_VALUE 0L
#undef java_net_Inet4Address_PREFER_IPV6_VALUE
#define java_net_Inet4Address_PREFER_IPV6_VALUE 1L
#undef java_net_Inet4Address_PREFER_SYSTEM_VALUE
#define java_net_Inet4Address_PREFER_SYSTEM_VALUE 2L
