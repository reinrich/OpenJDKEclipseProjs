 ...
 */
JNIEXPORT void JNICALL Java_java_net_PlainDatagramSocketImpl_socketSetOption0
  (JNIEnv *, jobject, jint, jobject);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_java_net_PlainDatagramSocketImpl_dataAvailable
  (JNIEnv *, jobject);
